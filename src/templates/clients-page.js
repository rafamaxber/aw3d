...
export const ClientsPageTemplate = ({ title, content, contentComponent }) => {
  ...
  return (
    <Container>
      <Helmet
        title="Clientes"
        description="Banco do Brasil, Conex, Lizzy Kahl, Agência Hub , Agência Hype/Renault, Forma Turismo, OMG Graduados, Chillibeans, iDesign Group (MAC Engenharia), Studio Caan (Disney), SV Usinagem, Mcaa Arquitetos, Studio Ino, Sinctronics, Projeto Mãos Dadas, Explorum, Kota, Magic Toys, IT4D, Centro Cultural Banco do Brasil, Thermoval, Vepan, Toys B2B, Click Automotiva, SESC Jundiaí, Poligeomeca, Ateliê Bia Cravol, Brinquedos Bandeirantes, L4U, Tecfil, Ateliê Modestamente Revolucionário, Tudo Mini, Ateliê Oficina da Memória (Titina Corso), Dra. Giselle Caselato, Interlight, LARC Engenharia, Likkaplas, Volkswagen do Brasil, Universidade Mackenzie, Universidade Federal do Semi-Árido"
      />
      <Title>
        <h1>{title}</h1>
      </Title>
